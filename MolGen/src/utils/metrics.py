...
def calc_novelty(train_set_molecules: List[str], gen_molecules: List[str]) -> float:
    """
    ...
    """ 
    new_molecules = set(gen_molecules) - set(train_set_molecules)

    return len(new_molecules) / len(gen_molecules)
