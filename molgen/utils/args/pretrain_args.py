...
def get_pretrain_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_type", type=str, required=True, options=["GPT", "DT"], help="Type of model to use for training")
    parser.add_argument("--dataset_type", type=str, required=True, options=["SMILES", "DT_SMILES"], help="Type of dataset to use for training")
